...
export interface FloppyDiskInterface {
  animate?: boolean
}

withDefaults(defineProps<FloppyDiskInterface>(), {
  animate: false
})
</script>

<template lang="pug">
svg(data-component='floppy-disk' viewbox='0 0 134 120' class='w-[13.4rem] h-[12rem] animate-insert')
